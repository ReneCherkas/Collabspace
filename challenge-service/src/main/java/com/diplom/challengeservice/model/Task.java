...
public class Task {
    ...
    private String kanbanStatus; // Для колонок Kanban (To Do/In Progress/Done)

    private String status; // Общий статус задачи (Open/Close)

    @Column(name = "closed_at")
    private LocalDateTime closedAt; // Время закрытия задачи
